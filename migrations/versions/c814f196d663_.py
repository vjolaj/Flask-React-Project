...
Revision ID: c814f196d663
Revises: 
Create Date: 2023-07-01 12:50:57.446696
...
def upgrade():
    ...
    sa.Column('deliveryMethod', sa.String(length=255), nullable=False),
    sa.Column('paymentDetails', sa.String(length=255), nullable=False),
    sa.Column('address', sa.String(length=255), nullable=False),
...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_table('shoppingCart_menuItems')
